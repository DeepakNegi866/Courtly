...
const AddCase = ({
  ...
  const {
    ...
    defaultValues: {
      opponents: [{ fullName: "", email: "", phoneNumber: "" }],
      opponentAdvocates: [{ fullName: "", email: "", phoneNumber: "" }], // Default one address field
    },
  });
  const {
  ...
  const {
    ...
    unregister: casePriortiyUnregister,
  ...
  const currentAppearing = watchCasePriority("appearingModel")
  ...
  useEffect(() => {
    if (currentAffidavit) {
      casePriortiyUnregister, "affidavitStatus";
    }
  }, [currentAffidavit]);
  ...
  const additionalInfo = (data) => {
    const filteredAdditionalFields = Object.fromEntries(
      Object.entries(data.additionalFields).filter(([_, value]) => value !== "")
    );
  ...
  const SubmitHandler = async () => {
    try {
      ...
      cleanObject;
      const res = await Axios.post("/case/add-case", filteredPayload, {
        authenticated: true,
      });
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="list-wrapper">
                <h1 className="add-case">Add Case</h1>
                <ol className="ps-3">
                  <li>
                  ...
                  <form onSubmit={handleCaseInfo(caseInfo)}>
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-3">
                        ...
                        <div
                          className={`accordion ${formstyle.financialYearAccordion}`}
                          id="accordionFinancialYear"
                        >
                          <div
                          ...
                          >
                            ...
                            <div
                              id="collapseOne"
                              className={`accordion-collapse collapse ${formstyle.financialAccordionCollapse}`}
                  ...
                  <div className="form-wrapper">
                    ...
                    <form onSubmit={handleCasePriority(casePriority)}>
                      <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="dateOfHearing" className="form-label">
                            Date Of Hearing
                          </label>
                          <input
                            type="date"
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12 mb-3">
                          <Search
                            ...
                            value={selectedClients} // Pass the selected clients (array of objects)
...
AddCase.getLayout = (page) => <ManagementLayout>{page}</ManagementLayout>;
