        ...
        <div className="container">
          <div className="row">
            <div className="col-md-10">
              <h1 className={`${termsStyle.terms_heading}`}>
                Terms and Conditions
              </h1>

              <p className={`${termsStyle.terms_para} pt-4`}>
                Welcome to digikase.com !
              </p>

              <p className={`${termsStyle.terms_para}`}>
                {" "}
                These terms and conditions outline the rules and regulations for
                the use of digikase Website, located at
                http://digikase.com .
              </p>
              ...
              <p className={`${termsStyle.terms_para}`}>
                ...
                conditions. Do not continue to use digikase.com if you do not
              ...
              <h3 className={`${termsStyle.terms_heading}`}>
                <strong>Cookies</strong>
              </h3>

              <p className={`${termsStyle.terms_para}`}>
                We employ the use of cookies. By accessing digikase.com , you
                agreed to use cookies in agreement with the digikase
                Privacy Policy.{" "}
              </p>
              ...
              <p className={`${termsStyle.terms_para}`}>
                Unless otherwise stated, digikase. and/or its licensors
                own the intellectual property rights for all material on
                digikase.com . All intellectual property rights are reserved.
                You may access this from digikase.com for your own personal
                use subjected to restrictions set in these terms and conditions.
              </p>

              <p className={`${termsStyle.terms_para}`}>You must not:</p>
              <ul className={`${termsStyle.terms_list}`}>
                <li>Republish material from digikase.com </li>
                <li>
                  Sell, rent or sub-license material from digikase.com{" "}
                </li>
                <li>
                  Reproduce, duplicate or copy material from digikase.com{" "}
                </li>
                <li>Redistribute content from digikase.com </li>
              </ul>

              <p className={`${termsStyle.terms_para}`}>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. digikase  does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of digikase ,its
                agents and/or affiliates. Comments reflect the views and
                opinions of the person who post their views and opinions. To the
                extent permitted by applicable laws, digikase  shall
              ...
              <p className={`${termsStyle.terms_para}`}>
              digikase  reserves the right to monitor all Comments
              ...
              <p className={`${termsStyle.terms_para}`}>
                You hereby grant digikase  a non-exclusive license to
              ...
              <p className={`${termsStyle.terms_para}`}>
                ...
                of digikase ; and (d) the link is in the context of
              ...
              <p className={`${termsStyle.terms_para}`}>
                ...
                by sending an e-mail to  digikase . Please include your
              ...
              <p className={`${termsStyle.terms_para}`}>
                No use of digikase 's logo or other artwork will be
...
TermsCondition.getLayout = (page) => <ManagementLayout>{page}</ManagementLayout>;
